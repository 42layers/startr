<?php
if (class_exists("ModuleCanvas") && !class_exists("ModulePostTypeTestemonials")) {
    /**
     ...
     */
    class ModulePostTypeTestemonials extends ModuleCanvas
    {
      // Definimos o nome do custom post type
      public $name = 'testemonial';
        ...
        public function hooks()
        {
          ...
          addPostType("Depoimentos", "Depoimento", $this->name, 'dashicons-groups');
    ...
    /* Runs Module */
    new ModulePostTypeTestemonials();
}