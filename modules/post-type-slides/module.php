<?php
if (class_exists("ModuleCanvas") && !class_exists("ModulePostTypeSlide")) {
    /**
     ...
     */
    class ModulePostTypeSlide extends ModuleCanvas
    {
      ...
      public $name = 'slide';
        ...
        public function hooks()
        {
          ...
          addPostType("Slides", "Slide", $this->name, 'dashicons-format-gallery');
